...
from app.routers import auth, members, attendance, icare, cgsl, ministries, dashboard, activity_types, activity_sessions, activity_registrations, users, roles, reports
...
app.include_router(cgsl.router)
